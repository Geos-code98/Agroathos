...
class guiaathosdt2021form(forms.ModelForm):

	def __init__(self, *args, **kwargs):
		super(guiaathosdt2021form, self).__init__(*args, **kwargs)
...
class guiadetallesathosdt2021form(forms.ModelForm):

	def __init__(self, *args, **kwargs):
		anexozona=kwargs.pop("anexo_zona")
		anexofundo=kwargs.pop("anexo_fundo")
		super(guiadetallesathosdt2021form, self).__init__(*args, **kwargs)
		...
		self.fields['anexo_material']=forms.ModelChoiceField(label="Material", queryset=MaterialAcopio.objects.filter(anexo_cultivo=4))
	...
	class Meta:
		model = GuiaDetallesAthosDtIca2022
		fields = [
...
class infopaletdt2021form(forms.ModelForm):

	def __init__(self, *args, **kwargs):
		super(infopaletdt2021form, self).__init__(*args, **kwargs)
